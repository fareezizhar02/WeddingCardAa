  ...
  return (
    <motion.div variants={containerVariants} initial="initial" animate="animate" className="w-full">
      ...
      >
        ...
        {/* Scroll fade indicators (no arrows, more solid) */}
        ...
        {/* Scroll area */}
        <div className="scroll-minimal max-h-[52vh] overflow-y-auto px-5 py-5 sm:px-6 sm:py-6">
          <div className="space-y-5 text-center">
            ...
            >
              ...
              <br />
              kami memohon kepada-Mu agar Engkau limpahkan keberkatan dan rahmat ke atas perkahwinan:
            </motion.p>
            ...
            >
              Sebagaimana doa Rasulullah ﷺ kepada pasangan yang baru mendirikan rumah tangga:
            </motion.p>
            ...
            <motion.p
              ...
              className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600"
            >
              “Semoga Allah memberkati kamu, melimpahkan keberkatan ke atas perkahwinan kamu, dan
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                Ya Allah, jadikanlah perkahwinan mereka kekal hingga ke akhir hayat, peliharalah mereka
                daripada perpisahan dan perselisihan.
              </p>

              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                Kurniakanlah kepada mereka hati yang saling memahami, mampu bergelak tawa bersama,
                dan bersabar serta setia dalam susah dan senang.
              </p>

              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                Lapangkanlah rezeki mereka, berkatilah setiap usaha dan langkah kehidupan mereka, serta
                kurniakan kejayaan di dunia dan di akhirat.
              </p>

              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                Ya Allah, jadikanlah perkahwinan ini sumber kebaikan kepada agama-Mu, memberi manfaat
                kepada keluarga, serta membawa kebaikan dan contoh yang baik kepada masyarakat.
              </p>

              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                Dan sekiranya Engkau kurniakan mereka zuriat, maka jadikanlah anak-anak mereka elok
                rupa parasnya, mulia akhlaknya, taat kepada ibu bapa, serta berjuang dan beristiqamah
                di jalan-Mu.
              </p>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="space-y-3 pt-1">
              ...
              <p className="font-montserrat text-[13px] sm:text-[14px] leading-relaxed text-stone-600">
                “Wahai Tuhan kami, kurniakanlah kepada kami pasangan dan zuriat sebagai penyejuk mata,
