...
export default function CalendarSheet({ isOpen, onClose }: CalendarSheetProps) {
  // Event details
  const title = 'Majlis Perkahwinan Fareez & Zanis'
  const location =
    'NO. 6, JALAN TASIK SENANGIN 12/2, SEKSYEN 12, BANDAR TASIK SENANGIN, 71750 LENGGENG, NEGERI SEMBILAN'
  const description = 'Sila hadir memeriahkan majlis kami. Terima kasih!'
  const timezone = 'Asia/Kuala_Lumpur'

  // Google Calendar (UTC)
  const googleStartUTC = '20260328T040000Z'
  const googleEndUTC = '20260328T100000Z'
              ...
              <div className="px-6 py-6 space-y-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <div className="w-8 h-8 flex items-center justify-center">
                      <svg viewBox="0 0 24 24" className="w-10 h-10" fill="#000000">
